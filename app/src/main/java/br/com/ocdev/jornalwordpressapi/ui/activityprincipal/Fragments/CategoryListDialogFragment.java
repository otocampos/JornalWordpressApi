package br.com.ocdev.jornalwordpressapi.ui.activityprincipal.Fragments;
...
public class CategoryListDialogFragment extends BottomSheetDialogFragment {
    ...
    public static CategoryListDialogFragment newInstance(int itemCount) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View viewroot = inflater.inflate(R.layout.fragment_category_list_dialog, container, false);
        RecyclerView recyclerView = (RecyclerView) viewroot.findViewById(R.id.list);
        recyclerView.setLayoutManager(new GridLayoutManager(getContext(), 4));
        recyclerView.setAdapter(new CategoryAdapter(5));
...
/*
    ...
    public  class CategoryAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public CategoryAdapter(int itemCount) {
